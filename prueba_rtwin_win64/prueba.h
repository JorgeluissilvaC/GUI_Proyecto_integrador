...
#define prueba_rtModel                 RT_MODEL_prueba_T
...
typedef struct {
  ...
  int32_T Impulse_COUNT;               /* '<Root>/  Impulse' */
} DW_prueba_T;
...
#define rtB                            prueba_B
#define BlockIO                        B_prueba_T
#define rtX                            prueba_X
#define ContinuousStates               X_prueba_T
#define rtXdot                         prueba_XDot
#define StateDerivatives               XDot_prueba_T
#define tXdis                          prueba_XDis
#define StateDisabled                  XDis_prueba_T
#define rtP                            prueba_P
#define Parameters                     P_prueba_T
#define rtDWork                        prueba_DW
#define D_Work                         DW_prueba_T
...
struct P_prueba_T_ {
  real_T Ramp_X0;                      /* Mask Parameter: Ramp_X0
                                        ...
                                        */
  real_T parabola_X0;                  /* Mask Parameter: parabola_X0
                                        * Referenced by: '<S2>/Constant1'
                                        */
  real_T Ramp_slope;                   /* Mask Parameter: Ramp_slope
                                        * Referenced by: '<S1>/Step'
                                        */
  real_T parabola_slope;               /* Mask Parameter: parabola_slope
  ...
  real_T Ramp_start;                   /* Mask Parameter: Ramp_start
                                        ...
                                        *   '<S1>/Step'
                                        */
  real_T parabola_start;               /* Mask Parameter: parabola_start
                                        * Referenced by:
                                        *   '<S2>/Constant'
                                        *   '<S2>/Step'
                                        */
  ...
  real_T p22_Value;                    /* Expression: 0
                                        ...
                                        */
  real_T step_Value;                   /* Expression: 5
