...
MODEL                := prueba
MODULES              := prueba_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := prueba.mk
...
#
MODELLIB                  := pruebalib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := prueba_ref.rsp
MODELREF_INC_PATH         := 
