...
% Last Modified by GUIDE v2.5 22-Sep-2016 21:37:05
...
% --- Executes during object creation, after setting all properties.
function eje_CreateFcn(hObject, eventdata, handles)
% hObject    handle to eje (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
% Hint: place code in OpeningFcn to populate eje
p=imread('diag.png');
image(p);
axis off;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global n1 n2 n3 n4 A B C D;
tft=((n1*n2)*n3)/(1+((n1*n2)*n3)*n4);
[b,a]=tfdata(tft,'v');
[A,B,C,D]=tf2ss(b,a);
s=evalc('tft');
idx = findstr(s,sprintf('\n'));
...
% axes(handles.axes8);
% bode(tft,logspace(0.1,10^5,1000));
...
% --- Executes during object creation, after setting all properties.
function ani_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ani (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate ani
